...
ALLOWED_HOSTS = [
    ...
    'giggles-grins-9b5ffdf8ecd6.herokuapp.com',
    'localhost',
    '127.0.0.1',
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'giggles-grin'
    ...
    STATIC_URL = STATIC_URL = 'https://giggles-grin.s3.amazonaws.com/static/'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/media/'

else:
    # Whitenoise storage for static files in non-AWS environments
